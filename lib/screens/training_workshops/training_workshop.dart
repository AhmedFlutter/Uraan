...
class TrainingWorkshops extends StatefulWidget {
  TrainingWorkshops({Key key}) : super(key: key);
  static String routeName = '/training_workshop';

  @override
  _TrainingWorkshopScreenState createState() => _TrainingWorkshopScreenState();
}

class _TrainingWorkshopScreenState extends State<TrainingWorkshops> {

  HomeScreenLayout _homeScreenLayout = HomeScreenLayout(
    // parentDropdown: ParentDropdown.,
    childDropDown: ChildDropDown.TrainingWorkshops
  );
