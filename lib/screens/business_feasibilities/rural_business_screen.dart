...
class RuralBusinesses extends StatefulWidget {
  RuralBusinesses({Key key}) : super(key: key);
  static String routeName = '/rural_business';

  @override
  _RuralBusinessesScreenState createState() => _RuralBusinessesScreenState();
}

class _RuralBusinessesScreenState extends State<RuralBusinesses> {

  HomeScreenLayout _homeScreenLayout = HomeScreenLayout(
    parentDropdown: ParentDropdown.BusinessFeasibilities,
    childDropDown: ChildDropDown.RuralBusiness
  );
