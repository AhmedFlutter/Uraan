...
class UrbanBusinesses extends StatefulWidget {
  UrbanBusinesses({Key key}) : super(key: key);
  static String routeName = '/urban_business';

  @override
  _UrbanBusinessesScreenState createState() => _UrbanBusinessesScreenState();
}

class _UrbanBusinessesScreenState extends State<UrbanBusinesses> {

  HomeScreenLayout _homeScreenLayout = HomeScreenLayout(
    parentDropdown: ParentDropdown.BusinessFeasibilities,
    childDropDown: ChildDropDown.UrbanBusiness
  );
