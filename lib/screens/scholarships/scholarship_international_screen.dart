...
class ScholarShipInterNationalScreen extends StatefulWidget {
  ScholarShipInterNationalScreen({Key key}) : super(key: key);
  static String routeName = '/scholarShip_international';

  @override
  _ScholarShipScreenState createState() => _ScholarShipScreenState();
}

class _ScholarShipScreenState extends State<ScholarShipInterNationalScreen> {

  HomeScreenLayout _homeScreenLayout = HomeScreenLayout(
    parentDropdown: ParentDropdown.ScholarShips,
    childDropDown: ChildDropDown.InternationalScholarShips
  );
  ...
  Widget build(BuildContext context) {
    return _homeScreenLayout.build(
      context,
      body(context),
      title: "Scholarships International"
    );
  }
