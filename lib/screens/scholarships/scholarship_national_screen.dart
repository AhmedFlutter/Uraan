...
class ScholarShipNationalScreen extends StatefulWidget {
  ScholarShipNationalScreen({Key key}) : super(key: key);
  static String routeName = '/scholarShip_national';

  @override
  _ScholarShipScreenState createState() => _ScholarShipScreenState();
}

class _ScholarShipScreenState extends State<ScholarShipNationalScreen> {

  HomeScreenLayout _homeScreenLayout = HomeScreenLayout(
    parentDropdown: ParentDropdown.ScholarShips,
    childDropDown: ChildDropDown.NationalScholarShips
  );
